"""
Django settings for spellbound_project project.
...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-c5thwxst2u5&+9wg)%degs)30pn!@cbmp%!#dhpwq-t861e^yl')
...
ROOT_URLCONF = 'spellbound_project.urls'
...
WSGI_APPLICATION = 'spellbound_project.wsgi.application'
...
STATICFILES_DIRS = [
    BASE_DIR / 'spellbound_project' / 'static',
]
